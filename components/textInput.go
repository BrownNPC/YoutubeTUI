// Fork of textinput v1 with v2 support because the one upstream is broken (typing doesnt do anything)
package components
...
func (m *TextInput) setValueInternal(runes []rune, err error) {
	m.Err = err
...
func (m *TextInput) SetSuggestions(suggestions []string) {
...
func (m TextInput) Update(msg tea.Msg) (TextInput, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		default:
			...
			m.insertRunesFromUserInput([]rune(msg.String()))
		}
...
func (m TextInput) completionView(offset int) string {
	var (
		value = m.value
		style = m.PlaceholderStyle.Inline(true).Render
	)
...
func (m *TextInput) getSuggestions(sugs [][]rune) []string {
...
func (m *TextInput) nextSuggestion() {
...
func (m *TextInput) previousSuggestion() {
	m.currentSuggestionIndex = (m.currentSuggestionIndex - 1)
...
func (m TextInput) validate(v []rune) error {
	if m.Validate != nil {
